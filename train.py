...
from parallel.parallel import SubprocVecEnv
...
if args.algo == 'dqn':
    ...
    # create env
    single_env = wrap_cover_pendulun_conti(ENV_NAME, episode_length=EPISODE_LENGTH)
    # define agent 
...
def main():
    ...
    for step in range(1, STEP_NUM // N_ENVS + 1):
        ...
        algo.store_transition(s, a, r, s_, done)
